  ...
  return <>
    ...
    <main id="contenu" className="w-full max-w-full overflow-x-hidden">
      <section className="hero mx-auto grid max-w-[1440px] grid-cols-1 items-center gap-8 px-6 pb-16 pt-6 md:grid-cols-[1.08fr_1fr] md:gap-8 md:px-14 md:pb-20 md:pt-9">
        ...
        <figure className="hero-photo relative min-w-0"><div className="overflow-hidden rounded-tl-[120px] rounded-br-[100px] md:rounded-tl-[180px]"><img src="/images/panini-hero.png" alt="Panini grillé à la mozzarella, à la tomate et au basilic, image d’illustration" width="1536" height="1024" fetchPriority="high" className="h-[390px] w-full object-cover md:h-[565px]"/></div><figcaption className="mt-3 text-right text-xs text-muted-foreground">Suggestion gourmande · visuel d’illustration</figcaption></figure>
      </section>
